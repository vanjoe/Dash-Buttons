...
def pcbway_gen(project_name,project_rev):
    ...
    sh_run(f"kicad-cli pcb export pos --side front {project_name}.kicad_pcb -o manufacture/front.pos")
    sh_run(f"kicad-cli pcb export pos --side back {project_name}.kicad_pcb -o manufacture/back.pos")
